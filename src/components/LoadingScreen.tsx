  ...
  return (
    ...
    >
      <button
        ...
        className={clsx(
          "rounded-2xl px-10 py-4 text-[42px] leading-none outline-none transition-transform duration-400 ease-[cubic-bezier(0.34,1.56,0.64,1)] max-md:px-20 max-md:text-[32px]",
          {
            "cursor-default border-none bg-transparent text-[#e6dede]":
              phase === "loading",
